...
import { RegisterService, MessageService, ReserveService, SocialService } from '../_services/index';
...
debugger;
  ...
  private activaCuenta(token: string) {
    ...
    this.registerService.activa(token)
      .subscribe(
      data => {
  ...
  confirma() {
    ...
    this.reserveService.confirmaReserva(this.id)
      .subscribe(
      data => {
