...
var PaisService = (function () {
    ...
    PaisService.prototype.getAll = function () {
        var param = encodeURIComponent('<params accion="C" />');
        return this.http.get('/api/paises/all/' + param, this.jwt()).map(function (response) { return response.json(); });
    };
    // getById(id: string) {
    ...
    PaisService.prototype.jwt = function () {
