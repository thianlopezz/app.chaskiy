...
var AerolineaService = (function () {
    function AerolineaService(http) {
        this.http = http;
    }
    AerolineaService.prototype.getAll = function () {
        var param = encodeURIComponent('<params accion="C" />');
        return this.http.get('/api/aerolineas/all/' + param, this.jwt()).map(function (response) { return response.json(); });
    };
    // getById(id: string) {
    ...
    AerolineaService.prototype.jwt = function () {
