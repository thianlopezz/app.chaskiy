...
class Pago {
  get(idReserva, res) {
    ...
    dataAccess
      .execJsonToSp('pg_pago', { accion: 'C', idReserva })
      .then(result => {
  ...
  getByRango(params, res) {
    ...
    dataAccess
      .execJsonToSp('pg_pago', Object.assign({ accion: 'C1' }, params))
      .then(result => {
        res.send({ success: true, data: result[0] });
      })
      .catch(error => {
